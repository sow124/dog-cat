  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(`http://apis.data.go.kr/1543061/abandonmentPublicSrvc/abandonmentPublic?bgnde=20230101&endde=${today}&upkind=417000&pageNo=${page}&numOfRows=10&ServiceKey=${API_KEY}`);
